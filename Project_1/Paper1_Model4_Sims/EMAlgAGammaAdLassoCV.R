...
EMAlgAGammaAdLassoCV <- function(Data, Best, initial_Model_Params, tuningpA, weights){
  ...
  while(continue_status){
    ...
    myDiff <- Convergence_check(Old_Par[-c(6, 7, 8)], M_estimates)
