## Model_Matrix_Param_Sparse_cons2.R
...
Model_Params$Pi1 <- matrix(runif(meta_param$z1*meta_param$m, -1, 1),nrow = meta_param$z1)
...
Model_Params$Omega1 <- matrix(runif(meta_param$z1*meta_param$u, -1, 1),nrow = meta_param$z1)
