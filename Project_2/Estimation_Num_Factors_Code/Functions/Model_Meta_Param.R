...
meta_param$m = 4  ## number of joint/shared latent factors for X part 
meta_param$q1 = 50  ## number of variables in X1 (block 1 of X) 
meta_param$u1 = 2  ## number of separate latent factors for X1 part
meta_param$q2 = 50  ## number of variables in X2 (block 2 of X)
meta_param$u2 = 3  ## number of separate latent factors for X2 part
meta_param$u = meta_param$u1 + meta_param$u2

meta_param$j = 5  ## number of joint/shared latent factors for Y part  
meta_param$p1 = 50   ## number of variables in Y1 (block 1 of Y)
meta_param$z1 = 4   ## number of variables in Y1 (block 1 of Y) 
meta_param$p2 = 50    ## number of variables in Y2 (block 2 of Y)
meta_param$z2 = 3   ## number of variables in Y2 (block 2 of Y) 
