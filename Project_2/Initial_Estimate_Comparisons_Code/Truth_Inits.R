...
test <- EMAlgXAdLassoCV(Xpanel = list(t(X1), t(X2)), x_joint = m, x_indiv = c(u1, u2), Ainits = list(A1, A2), Binits = list(B1, B2), vcovinits = list(PhiR, PhiS1, PhiS2, Phi11, Phi12), tuningpA = 0, tuningpB = 0, weightsA = list(A1, A2), weightsB = list(B1, B2))
...
saveRDS(Results, file=paste0("TruthAltEstrep", datset, ".rds"))