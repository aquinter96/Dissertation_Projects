...
Y_inits <- function(Data, Xest, j, z){
  ...
  inits$Gamma1 <- Gamma1est
  inits$Delta1 <- Delta1est
  inits$Gamma2 <- Gamma2est
  inits$Delta2 <- Delta2est
  
  inits$Theta <- Thetaest
  inits$Psi <- Psiest
  inits$Pi1 <- Pi1est
  inits$Omega1 <- Omega1est
  inits$Pi2 <- Pi2est
  inits$Omega2 <-Omega2est
