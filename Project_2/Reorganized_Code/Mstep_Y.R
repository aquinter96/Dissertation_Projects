...
Mstep_Y <- function(Data, Old_Par, E_estimates, tuningpG1, tuningpD1, tuningpG2, tuningpD2, weights){
  ...
  Pi1    <-  Old_Par$Pi1
  Pi2    <-  Old_Par$Pi2
  Omega1 <-  Old_Par$Omega1
  Omega2 <-  Old_Par$Omega2
  ...
  p1 <-  ncol(Old_Par$Phi21)
  p2 <- ncol(Old_Par$Phi22)
  j <- ncol(Old_Par$Phi3)
  z1 <- ncol(Old_Par$Phi41)
  z2 <- ncol(Old_Par$Phi42)      
  n <- nrow(Y1)
  ...
  Pi1new <- (n*t(condvarRW1) + EW1%*%t(ER) - n*Old_Par$Omega1%*%t(condvarRS) - Old_Par$Omega1%*%ES%*%t(ER))%*%solve(n*condvarR + ER%*%t(ER))
  ...
  Omega1new <- (n*t(condvarSW1) + EW1%*%t(ES) - n*Pi1new%*%condvarRS - Pi1new%*%ER%*%t(ES))%*%solve(n*condvarS + ES%*%t(ES))
